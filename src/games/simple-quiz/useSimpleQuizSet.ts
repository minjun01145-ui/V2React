...
import { simpleQuizDemoSet } from "./demoSet.ts";
...
export function useSimpleQuizSet(session: ActiveGameSession): {
  ...
  return {
    set: (inlineSet as LearningSet | undefined) ?? remote.set ?? (setId ? null : simpleQuizDemoSet),
