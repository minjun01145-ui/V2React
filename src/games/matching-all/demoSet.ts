...
export const matchingAllDemoSet: RuntimeLearningSet = {
  id: "matching-all-demo",
  name: "모든카드 짝맞추기 체험 단어",
  ...
  ].map(([sourceText, meaning], index) => ({ id: `matching-all-demo-${index + 1}`, sourceText: sourceText ?? "", meaning: meaning ?? "" })),
};
