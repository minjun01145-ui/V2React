...
root.render(<StrictMode><AuthStatusPage title="관리자 화면을 준비하고 있어요" message="잠시만 기다려 주세요." /></StrictMode>);
...
void import("./TeacherApp.tsx")
  ...
  .catch((error: unknown) => {
    ...
    root.render(<StrictMode><AuthStatusPage title="관리자 화면을 시작할 수 없어요" message="환경 설정을 확인한 뒤 다시 시도해 주세요." error={message} /></StrictMode>);
  });
