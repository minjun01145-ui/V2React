...
root.render(<StrictMode><AuthStatusPage title="학생 화면을 준비하고 있어요" message="잠시만 기다려 주세요." /></StrictMode>);
...
void import("./TestStudentApp.tsx")
  ...
  .catch((error: unknown) => {
    ...
    root.render(<StrictMode><AuthStatusPage title="테스트 학생 화면을 시작할 수 없어요" message="환경 설정을 확인해 주세요." error={message} /></StrictMode>);
  });
